...
public class Constant implements Serializable {
    ...
    public static String GetPackageDetails  ="https://dhospitals.com/api/auth/getPackageDetails";
    public static String Getstate  ="https://dhospitals.com/api/auth/getState";
    public static String GetCity="https://dhospitals.com/api/auth/getCity";
    ...
    public static final String MainArray ="item";
